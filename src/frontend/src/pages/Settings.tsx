    ...
    <div className="p-6 max-w-2xl">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            onClick={() => {
              ...
              alert("Town root switching will be implemented in a future update.");
            }}
          >
            Connect
          </button>
      ...
      <section className="mb-8">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() => {
              if (confirm("This will attempt to fix any issues found. Continue?")) {
        ...
        {doctorMutation.data && (
          ...
          >
            {doctorMutation.data.data?.stdout || doctorMutation.data.message}
          </div>
        )}
      </section>
